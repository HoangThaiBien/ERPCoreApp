...
namespace ErpCore.Database.Migrations
{
    ...
    [Migration("20230224034353_ChangeDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpCore.Database.Entities.Slide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErpCore.Database.Entities.Location", b =>
                {
                    ...
                    b.HasOne("ErpCore.Database.Entities.District", null)
                        .WithMany("Locations")
                    ...
                    b.HasOne("ErpCore.Database.Entities.Province", null)
                        .WithMany("Locations")
                        .HasForeignKey("ProvinceId");

                    b.HasOne("ErpCore.Database.Entities.Ward", null)
                        .WithMany("Locations")
